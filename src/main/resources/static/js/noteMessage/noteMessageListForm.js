...
function drawNoteMessageTr(data, type){
    return `
        <div class="d-flex border-1 border-bottom mt-2">
            ...
            <div onclick="onProfileClick('${data.senderId}')" data-sender-id="${data.senderId}" class="col-3 px-3 text-center linkable text-black">${senderNameSetting(data.senderName)}</div>
