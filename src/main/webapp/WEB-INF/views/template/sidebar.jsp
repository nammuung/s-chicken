	...
	<ul class="sidebar-nav" id="sidebar-nav">
		...
		<li class="nav-item"><a class="nav-link collapsed"
			data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
				<i class="bi bi-menu-button-wide"></i><span>공지사항</span><i
				class="bi bi-chevron-down ms-auto"></i>
		</a>
			<ul id="components-nav" class="nav-content collapse "
				data-bs-parent="#sidebar-nav">
				<li><a href="/all/list"> <i class="bi bi-circle"></i><span>전체</span>
				</a></li>
				<li><a href="/represent/list"> <i class="bi bi-circle"></i><span>대표
							공지</span>
				</a></li>
				<li><a href="/cac/cacList"> <i class="bi bi-circle"></i><span>경조사
							공지</span>
				</a></li>
			</ul></li>
		<!-- End Components Nav -->
		...
		<li class="nav-item"><a class="nav-link collapsed"
			data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#"> <i
				class="bi bi-journal-text"></i><span>전자결재</span><i
				class="bi bi-chevron-down ms-auto"></i>
		</a>
			<ul id="forms-nav" class="nav-content collapse "
				data-bs-parent="#sidebar-nav">
				<li><a href="/document/list"> <i class="bi bi-circle"></i><span>결재
							문서</span>
				</a></li>
				<li><a href="/document/document"> <i class="bi bi-circle"></i><span>상신함</span>
				</a></li>
				<li><a href="/document/approvalList"> <i
						class="bi bi-circle"></i><span>결재함</span>
				</a></li>
				<li><a href="/document/ref"> <i class="bi bi-circle"></i><span>참조함</span>
				</a></li>
				<li><a href="/document/temp"> <i class="bi bi-circle"></i><span>임시저장</span>
				</a></li>
			</ul></li>
		<!-- End Forms Nav -->
		...
		<li class="nav-item"><a class="nav-link collapsed"
			data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#"> <i
				class="bi bi-gem"></i><span>가맹점 관리</span><i
				class="bi bi-chevron-down ms-auto"></i>
		</a>
			<ul id="icons-nav" class="nav-content collapse "
				data-bs-parent="#sidebar-nav">
				<li><a href="/franchise/join"> <i class="bi bi-circle"></i><span>가맹점
							가입</span>
				</a></li>
				<li><a href="/franchise/inquiry"> <i class="bi bi-circle"></i><span>가맹점
							조회</span>
				</a></li>
				<li><a href="/franchise/qna/list"> <i class="bi bi-circle"></i><span>가맹점
							QnA</span>
				</a></li>
				<li><a href="/franchise/faq/list"> <i class="bi bi-circle"></i><span>가맹점
							F.A.Q</span>
				</a></li>
			</ul></li>
		<!-- End Icons Nav -->
