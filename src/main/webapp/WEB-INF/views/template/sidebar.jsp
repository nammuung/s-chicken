...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        <sec:authorize access="!hasRole('ROLE_FRANCHISE')">
            ...
            <li class="nav-item">
                <a class="nav-link <c:if test="${cookie.navToggle.value ne '#components-nav'}">collapsed</c:if>"
            ...
            <li class="nav-item">
                <a class="nav-link <c:if test="${cookie.navToggle.value ne '#forms-nav'}">collapsed</c:if>"
                ...
                <ul id="forms-nav"
                    class="nav-content collapse <c:if test="${cookie.navToggle.value eq '#forms-nav'}">show</c:if>"
                    data-bs-parent="#sidebar-nav">
                    <li>
            ...
            <li class="nav-item">
                ...
                <ul id="icons-nav"
                    class="nav-content collapse <c:if test="${cookie.navToggle.value eq '#icons-nav'}">show</c:if>"
                    data-bs-parent="#sidebar-nav">
                    <li>
                    ...
                    <li>
                        <a href="/franchise/insight">
                            <i class="bi bi-circle"></i><span>인사이트</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item">
                ...
                <ul id="sell-nav"
                    class="nav-content collapse <c:if test="${cookie.navToggle.value eq '#sell-nav'}">show</c:if>"
                    data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/order">
...
<%--                    </li>--%>
            ...
            <li class="nav-item">
                ...
                <ul id="item-nav"
                    class="nav-content collapse <c:if test="${cookie.navToggle.value eq '#item-nav'}">show</c:if>"
                    data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/items">
