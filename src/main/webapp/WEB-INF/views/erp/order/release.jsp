                        ...
                        <div class="p-3 d-flex" style="width: 1200px;">
                            ...
                            <div style="width: 700px;">
                                <div class="d-flex justify-content-between" style="line-height: 40px; padding-bottom: 3px;">
                                    <b>상세</b>
                                    <div>
                                        <button class="btn btn-outline-primary d-none" id="allCompleteButton">전체출고</button>
...
<script type="module" src="/js/erp/release.js"> </script>
