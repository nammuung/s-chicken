                ...
                <tbody>                   
                    ...
                    <tr>
                        ...
                        <td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; height: 10px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;"
                            ...
                            <input type="text" readonly class="form-control" value ="${list[0].bonusVO.codeVO.name} ${list[0].bonusVO.employeeVO.name}" id="bonuspeo" style="width: 100%;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; height: 10px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;"
                            colspan="5">
                            <input type="text" class="form-control" value ="${list[0].bonusVO.bonus}" name="bonus" style="width: 100%;">
