...
<div class="btn-group" role="group" aria-label="Basic radio toggle button group">
    ...
    <label class="btn btn-outline-secondary" for="emp">그룹웨어</label> 
    
    <input type="radio" class="btn-check" name="options-base" id="fra" autocomplete="off"> 
    <label class="btn btn-outline-secondary" for="fra">가맹점</label>
</div>
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<div class="form-check mb-0">
										<input class="form-check-input me-2" type="checkbox" value=""
											...
											class="form-check-label" for="remember-me"> 기억하기 </label>
									</div>
